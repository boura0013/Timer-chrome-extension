...
function timerRing(){
    ...
    var chromeNotificationID = chrome.notifications.create('timerEndNotification', notificationOptions, function(id) {});
    setTimeout(clearNotification(chromeNotificationID));
    chrome.tabs.create({
